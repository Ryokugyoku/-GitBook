...
1. マイルストーンを作成したいリポジトリのWEBページに遷移する
2. ヘッダのメニューの「Issue」ボタンを押下する
3. 「Milestones」というボタンを押下する\
   ![](<../.gitbook/assets/スクリーンショット 2025-03-24 22.45.22.png>)
4. New milestoneボタンを押下する\
   ![](<../.gitbook/assets/スクリーンショット 2025-03-24 22.45.59.png>)
5. 任意のタイトルとDescription、締め日を入力する\
   ![](<../.gitbook/assets/スクリーンショット 2025-03-24 22.47.08.png>)
6. Create milestoneボタンを押下する
...
1.  マイルストーン名をクリックする\
    ...
    <figure><img src="../.gitbook/assets/スクリーンショット 2025-03-24 22.50.25.png" alt=""><figcaption></figcaption></figure>
2. マイルストーンに紐づくチケットが表示される\
   ![](<../.gitbook/assets/スクリーンショット 2025-03-24 22.52.01.png>)
